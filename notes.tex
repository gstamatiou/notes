...
\begin{remark}[Cocycle condition]
    To motivate the cocycle condition, consider a group $G$ acting on a space $X$. One can think of it as a condition that allows to define a flow over the fiber bundle $X \times G$ over $X$ that lifts the flow $\theta$ on $X$:
    \[
...
\begin{figure}[h]
    ...
    \end{figure}\todo{what if I pick some $\chi_2' \in (\chi_1, \chi_2)$ and consider the sequence $\chi_1 < \chi_2' < \chi_3 < \cdots < \chi_{k(x)}$?}
