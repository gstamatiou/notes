...
\section{2025-09-22}
\begin{itemize}
    \item Round metric on the sphere:\todo{Do the same for stereographic coordinates, see whether it is possible to obtain it in different coordinates directly through the euclidean metric, generalize to higher dimensions.}\\
